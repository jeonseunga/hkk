...
public class CenterHandler implements CommandHandler{
   ...
   public String process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
      ...
      ArrayList<FoodWriteDataBean> write = null;
      ArrayList<String> content = null;
      if(count!=0) {
         write = writeDao.getArticles(foodcode,start,end);
         write.size();
      ...
      if(foodcode == 1){
         ...
         return "/HKK_receipe/default.jsp";
      }
   }   
}