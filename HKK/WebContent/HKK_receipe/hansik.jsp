...
<jsp:include page="../HKK_menu.jsp" flush="false"/>
	...
	<div class="index2-banner">
		...
		<div class="index2-banner-text">
			...
			<div class="text-logo"><img src="/HKK/images/hansik.png" width="130" height="auto" 
    ...
    <table align="right">
      ...
      <div class="inedx-panel-header clearfloat">
		...
		<div class="index-panel-body index-food-list">
			<ul class="clearfloat">
			<c:set var="i" value="${0}"/>
				<c:forEach var="han" items="${write}">
				<li class="food-item">
				<a href="receipeView.do?food_connum=${han.food_connum}&food_code=${han.food_code}">
