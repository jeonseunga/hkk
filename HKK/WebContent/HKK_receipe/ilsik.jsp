...
<jsp:include page="../HKK_menu.jsp" flush="false"/>
	...
	<div class="index2-banner">
		...
		<div class="index2-banner-text">
			...
			<div class="text-logo"><img src="/HKK/images/ilsik.png" width="120" height="auto" 
			style="margin-left: 42%; margin-top:-3%"></div>
   ...
   <div class="index-panel">
    ...
    <table align="right">
      ...
      <div class="index-panel-body index-food-list">
         <ul class="clearfloat">
            <c:set var="i" value="${0}"/>
            <c:forEach var="il" items="${write}">
            <li class="food-item">
               <a href="receipeView.do?food_connum=${il.food_connum}&food_code=${il.food_code}">
