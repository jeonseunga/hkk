...
<jsp:include page="../HKK_menu.jsp" flush="false"/>
	...
	<div class="index2-banner">
		...
		<div class="index2-banner-text">
			...
			<div class="text-logo"><img src="/HKK/images/jungsik.png" width="120" height="auto" 
			style="margin-left: 42%; margin-top:-2%"></div>
   ...
   <div class="index-panel">
    ...
    <table align="right">
      ...
      <div class="index-panel-body index-food-list">
         <ul class="clearfloat">
            <c:set var="i" value="${0}"/>
            <c:forEach var="joong" items="${write}">
            <li class="food-item">
               <a href="receipeView.do?food_connum=${joong.food_connum}&food_code=${joong.food_code}">
