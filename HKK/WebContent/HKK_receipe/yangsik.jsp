...
<jsp:include page="../HKK_menu.jsp" flush="false"/>
	...
	<div class="index2-banner">
		...
		<div class="index2-banner-text">
			...
			<div class="text-logo"><img src="/HKK/images/yangsik.png" width="130" height="auto" 
   ...
   <div class="index-panel">
    ...
    <table align="right">
      ...
      <div class="index-panel-body index-food-list">
         <ul class="clearfloat">
            <c:set var="i" value="${0}"/>
            <c:forEach var="yang" items="${write}">
            <li class="food-item">
               <a href="receipeView.do?food_connum=${yang.food_connum}&food_code=${yang.food_code}">
