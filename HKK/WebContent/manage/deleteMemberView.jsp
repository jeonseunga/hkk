...
<body class="body">
  ...
  <div class="wrapper">
	<div class="con">
		...
		<form class="formMgb" method="post" action="deleteMemberPro.do">
			<table class="table">
				<input type="hidden" name="id" value="${id}">
				<tr>
					<th><input class="forminput2" type="text" name="id" placeholder="${id}" readonly></th>
					<th><input class="forminput2" type="text" name="id" placeholder="${msg_delete}" readonly></th>
				</tr>
				<tr>
