...
<div class="index2-banner">
	...
	<br>
	<div align = "center" >
	<form method="post" action="HKK_marketwritePro.do" name="MKwriteform" enctype="multipart/form-data" onsubmit="return MKwriteck()"> 
		<input type="hidden" name="m_connum" value="${m_connum}">	
		 <table  width = "900px">
         <tr> 
            <th class="line"> ${str_subject} </th>
            <td class="line"> <input class="textbox" type="text" name="m_title" maxlength="50"> </td>
         </tr>        
         <tr>
         ...
         <tr>
            <th colspan="2" class="line">
               ...
               <input class="button3" type="button" value="${btn_list}"
					onclick="location='HKK_marketList.do'">
            </th>
         </tr>
      </table>
	</form>
